        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Новости <a href="/{{ \Request::segment(1) }}/create" class="btn btn-success">+ Добавить</a></h4>
                </div>
            </div>
        </div>
                        ...
                        @foreach($data as $item)
                            <tr class="box__check">
                                ...
                                <td style="display: flex;">
                                    <a href="/{{ \Request::segment(1) }}/{{ $item->slug }}" target="_blank"
                                       class="btn btn-primary btn-sm" style="margin-right: 2px;"><i
                                                class="uil uil-eye font-size-18"></i></a>
                                    <a href="/{{ \Request::segment(1) }}/{{ $item->slug }}/edit"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/{{ \Request::segment(1) }}/{{ $item->slug }}" method="post">
                                                @csrf
                                                {{ method_field('delete') }}
